...
void    Vehicle::draw()
{
    std::cout << "Vehicle model is " << _model << std::endl
        << "Vehicle company is " << _company << std::endl
        << "Vehicle production year is " << _year << std::endl
        << "Vehicle price is " << _price << std::endl
        << "Vehicle weight is " << _weight << std::endl
        << "Vehicle maximal velocity is " << _maxV << std::endl;
}
